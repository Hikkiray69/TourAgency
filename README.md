# 🚀 Next.js Тур-агентство (Dockerized)

### Этот проект представляет собой веб-приложение турагентства, созданное на **Next.js** и упакованное в Docker-контейнер.
...
- Операционная система: Windows 10/11, macOS 10.14+ или Linux (Ubuntu, Fedora, Debian).

- Процессор: 64-разрядный (x86_64, ARM64).

- Оперативная память: минимум 4 ГБ (рекомендуется 8 ГБ и выше).

- Свободное место на диске: минимум 10 ГБ (для образов и контейнеров).
